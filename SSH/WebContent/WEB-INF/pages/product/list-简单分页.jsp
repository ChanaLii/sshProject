	...
	<div class="row">
		<div class="col-md-12">
			<ul class="pager">
				...
				<li><a href="listProduct.action?pageSize=8&curPage=${pagevo.curPage-1}">上一页</a></li>
				</s:if>
				<s:else>
					<li class="disabled"><a href="listProduct.action?pageSize=8&curPage=1">上一页</a></li>
				</s:else>
				<s:if test="pagevo.curPage<pagevo.totalPage">
					<li><a href="listProduct.action?pageSize=8&curPage=${pagevo.curPage+1}">下一页</a></li>
				</s:if>
				<s:else>
				<li class="disabled"><a href="listProduct.action?pageSize=8&curPage=${pagevo.totalPage}">下一页</a></li>
				</s:else>
			</ul>
		</div>
